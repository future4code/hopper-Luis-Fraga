//Exercício de intepretação de código
//1- A- Vai imprimir o nome e o apelido de todos
//2- Apenas os nomes
//3- Vai filtrar apenas o item selecionado
...
/*
const novoArray = produtos.filter((ype) => {
...
const pokemons = [
 ...
 const nomePoke = pokemons.map((poke) => poke.nome).sort()
...
const arrayTipos = new Set(); //Object
pokemons.map((poke) => {
  arrayTipos.add(poke.tipo);
});
